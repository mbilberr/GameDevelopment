...
if (inputting) {
    ...
    switch (ds_[#1, menu_option[page]]) {
		...
		switch(menu_option[page]){
			case 0: if(!audio_is_playing(knithawk_laugh)){ audio_play_sound(knithawk_laugh, 1,false);}
			break;
			case 1: if(!audio_is_playing(knithawk_laugh)){ audio_play_sound(knithawk_laugh, 1,false);}
			break;
			case 2: if(!audio_is_playing(knithawk_laugh)){ audio_play_sound(knithawk_laugh, 1,false);}
			break;
		}
